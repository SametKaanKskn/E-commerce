...
public class ShoppingCart {
    ...
    // @JoinTable(
    // name = "sepet_urunler",
    // joinColumns = @JoinColumn(name = "sepet_id", referencedColumnName =
    // "sepet_id"),
    // inverseJoinColumns = @JoinColumn(name = "urun_id", referencedColumnName =
    // "urun_id")
    // )
    ...
    public void removeProduct(Product product) {
        for (Iterator<CartProducts> iterator = products.iterator(); iterator.hasNext();) {
