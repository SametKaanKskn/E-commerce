...
import com.sametkagankeskin.ecommerce.exception.category.CategoryAlreadyExistsException;
import com.sametkagankeskin.ecommerce.exception.category.CategoryNotFoundException;
...
import com.sametkagankeskin.ecommerce.repository.CategoryRepository;
...
public class CategoryServiceImpl implements CategoryService {
    ...
    public List<CategoryDto> getAllCategories() {
        return categoryRepository.findAll().stream()
                .map(category -> modelMapperManager.forResponse().map(category, CategoryDto.class))
