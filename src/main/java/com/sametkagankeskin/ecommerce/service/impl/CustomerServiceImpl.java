...
import com.sametkagankeskin.ecommerce.exception.NotFoundException;
import com.sametkagankeskin.ecommerce.exception.customer.CustomerAlreadyExistsException;
...
public class CustomerServiceImpl implements CustomerService {
    ...
    public List<CustomerDto> getAllCustomers() {
        return customerRepository.findAll().stream()
                .map(customer -> modelMapperManager.forResponse().map(customer, CustomerDto.class))
    ...
    public int addNewCustomer(AddCustomerVm customerVm) {
        ...
        String message = customer.getCustomerFirstName() + " " + customer.getCustomerLastName()
                + " isimli kullanıcı sisteme eklendi!";
        logger.info(message);
    ...
    public String updateWallet(UpdateWalletVm walletVm) {
        ...
        customerRepository.save(customer);
        return "Sayın " + customer.getCustomerFirstName() + " " + customer.getCustomerLastName() + " cüzdanınıza "
                + walletVm.getWallet() + " TL eklendi. Toplam Bakiyeniz: " + customer.getWallet();
    }
